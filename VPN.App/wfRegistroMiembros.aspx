        ...
        <div class="form-group row">
         ...
         <div class="form-group row">
             <div class="col-sm-12" style="text-align: center">
                    ...
                    ErrorMessage="Ingrese un mínimo 6 números, y un máximo 10 números"            
                    ValidationExpression="^[\s\S]{6,10}$"
        ...
        <div class="form-group row">
            <div class="col-sm-4">
                    <asp:RadioButtonList ID="rbSintomasCovid" runat="server" required="required" aria-required="true" RepeatDirection="Horizontal">
                        <asp:ListItem Value="1" style="text-align: center">&nbsp; No tengo síntomas &nbsp;&nbsp;</asp:ListItem>
                        <asp:ListItem Value="0" style="text-align: center">&nbsp; Sí tengo síntomas </asp:ListItem>
                    </asp:RadioButtonList>
            </div>
